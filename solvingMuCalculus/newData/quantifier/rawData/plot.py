...
plt.grid(which='both')
plt.savefig("figures/Quantifiers-processedData.png")
...
plt.ylabel("Time(s)")
#plt.ylabel("log_10(Time(s))")
plt.title("Raw data:Time taken to evaluate terms with varying quantifiers")
plt.savefig("figures/Quantifiers-rawData.png")
plt.show()
